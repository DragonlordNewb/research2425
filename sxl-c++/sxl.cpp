...
class SXL {
    ...
    public:
        ...
        void define(string name) {
            if (name == "connection coefficients" || name == "christoffel symbols" || name == "christoffel" || name == "ccs" || name == "css") {
                manifold.define<tensors::ConnectionCoefficients>();
            }
        }
        ...
        void processCommand(const std::vector<std::string>& tokens) {
            ...
            if (tokens[0] == "manifold") {
                ...
                if (subcommand == "create") {
                    ...
                    if (co) cout << GiNaC::latex << manifold.co(tensorName, indices) << GiNaC::dflt << endl;
                }
                else {
